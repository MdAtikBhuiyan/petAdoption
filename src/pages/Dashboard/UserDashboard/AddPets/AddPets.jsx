...
const AddPets = () => {
    ...
    const { values, handleChange, handleSubmit, errors } = useFormik({
        ...
        //     //     errors.petCategory = 'Category is Required';
        //     // }
        //     // if (!values.petLocation) {
        //     //     errors.petLocation = 'Location is Required';
        //     // }
        //     // if (!values.petShortDes) {
        //     //     errors.petShortDes = 'Short description is Required';
        //     // }
        //     // if (!values.petLongDes) {
        //     //     errors.petLongDes = 'Pet Age is Required';
        //     // }
        //     // if (!values.petImg) {
        //     //     errors.petImg = 'Image is Required';
        //     // }
        //     return { errors };
        // },
        ...
        onSubmit: (values, { resetForm }) => {
            ...
            let addPetInfo = { ...values, adopted: false }
            ...
            if (values) {
                fetch(cloudinary_api, {
                    ...
                    .then((data) => {
                        // console.log(data);
                        addPetInfo.petImg.url = data.url;
                    })
                    .catch(err => console.error(err));

                console.log(addPetInfo);
                axiosPublic.post('/allPets', addPetInfo)
                    .then(res => {
